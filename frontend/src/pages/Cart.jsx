...
const Cart = () => {
    ...
    useEffect(() => {
        ...
        console.log("Query params detectados:", queryParams.toString());
        if (queryParams.get("paymentFailed")) {
    ...
    return (
        <div>
            {paymentFailed && (
                <div className="p-4 mb-4 text-white bg-red-900 border border-red-700 rounded-md">
                    🚨 ERROR: El pago no se completó correctamente. Inténtalo de nuevo.
                </div>
            )}
